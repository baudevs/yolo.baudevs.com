...
LDFLAGS=-ldflags "-X main.Version=$(VERSION) -X main.BuildTime=$(BUILD_TIME) \
           -X github.com/baudevs/yolo.baudevs.com/internal/version.Version=$(VERSION) \
           -X github.com/baudevs/yolo.baudevs.com/internal/version.GitCommit=$(GIT_COMMIT) \
           -X github.com/baudevs/yolo.baudevs.com/internal/version.BuildDate=$(BUILD_DATE)"

# Supported platforms for cross-compilation
PLATFORMS=darwin/amd64 darwin/arm64 linux/amd64 linux/arm64

.PHONY: all build build-all clean test coverage deps lint install uninstall release
